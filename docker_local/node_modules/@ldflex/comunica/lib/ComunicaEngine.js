...
var _comunicaEngine = _interopRequireDefault(require("../lib/comunica-engine"));
...
class ComunicaEngine {
  ...
  constructor(defaultSource) {
    this._engine = _comunicaEngine.default; // Preload sources but silence errors; they will be thrown during execution
  ...
  async parseSources(source) {
    ...
    if (typeof sources === 'string') sources = [sources.replace(/#.*/, '')]; // Flatten recursive calls to this function
      ...
      else if (typeof sources.match === 'function') sources = [Object.assign({
          type: 'rdfjsSource'
