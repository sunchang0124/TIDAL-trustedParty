...
class RdfParser {
    ...
    parse(textStream, options) {
        ...
        options['@comunica/actor-rdf-parse-jsonld:documentLoader'] =
            new PrefetchedDocumentLoader_1.PrefetchedDocumentLoader({
                contexts: options.contexts || {},
                logger: options.logger,
                path: options.path,
            });
        // Enable strict parsing of JSON-LD to error on potential user config errors
        options['@comunica/actor-rdf-parse-jsonld:strictValues'] = true;
        // Execute parsing
