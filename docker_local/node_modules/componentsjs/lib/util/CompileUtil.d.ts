 ...
 */
export declare function compileConfig(mainModulePath: string, configPath: string, configIri: string, exportVariableName?: string, asFunction?: boolean): Promise<string>;
