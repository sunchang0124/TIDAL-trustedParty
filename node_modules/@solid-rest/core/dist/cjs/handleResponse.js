...
async function handleResponse(response, originalRequest) {
  ...
  */
  ...
  headers.statusText = headers.statusText || statusText[headers.status]; // Now we create & return the Response object
  ...
  try {
    responseObject = new _crossFetch.Response(body, headers);
  } catch (e) {
    console.log("Error " + e);
  }
